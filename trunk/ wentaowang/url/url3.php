...
class  gather {
	...
	//	echo $content;
		...
		//****************
		preg_match_all("/<divclass=\"left_bk1_title\">(.*?)<\/ul>/is",$content,$Arraytitle);
		
	preg_match_all("/href=\"(.*?)\"/is",$Arraytitle[1][1],$Arraytitle);
...
//	$data['time']=time();
	...
	function run(){
		...
		$url=array( 'http://book.dangdang.com/01.45.htm?ref=book-01-A');
