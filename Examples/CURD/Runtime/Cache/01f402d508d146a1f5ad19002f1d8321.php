...
<script type="text/javascript" src="__PUBLIC__/Js/Ajax/ThinkAjax.js"></script>
 ...
 <tr>
	...
	<td class="tLeft" ><input type="text" name="title" style="height:23px" class="large bLeft" value="<?php echo ($vo["title"]); ?>"></td>
 </tr>
  <tr>
	<td class="tRight" >邮箱：</td>
	<td class="tLeft" ><input type="text" name="email" style="height:23px" class="huge bLeft" value="<?php echo ($vo["email"]); ?>"></td>
 </tr>
 <tr>
	<td class="tRight tTop" >内容：</td>
	<td><textarea name="content" class="huge bLeft" rows="8" cols="25"><?php echo ($vo["content"]); ?></textarea></td>
 </tr>
 <tr>
	<td><input type="hidden" name="ajax" value="1"><input type="hidden" name="id" value="<?php echo ($vo["id"]); ?>"></td>
